...
class _BetDetailsState extends State<BetDetails> with TickerProviderStateMixin {
  ...
  var sizes = [600.0, 300.0, 300.0, 300.0];
  @override
  ...
  Widget liveInfoTab() {
    ...
    var odiData = widget.matchData["liveScore"];
    var perOver = widget.matchData['overRuns']['OverNo'].toString();

    dynamic batBallInfo(data) {
      ...
      Container(
        child: Column(children: [
              ...
              child: Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Center(
                      child:
                          Text("Over: " + (odiData['Over'] ?? '--').toString(),
                              textAlign: TextAlign.center,
                              style: TextStyle(
                                color: Colors.white,
                                fontSize: 16,
            ...
            child: Container(
              ...
              child: Padding(
                ...
                child: Center(
                  child: Text(
                      'On Batting : ' +
                          (batBallInfo(odiData['Bat']))['Team'].toString(),
                      textAlign: TextAlign.center,
                      style: TextStyle(
                        color: Colors.white,
                        fontSize: 16,
          ...
          Row(children: [
            OverRun(
              color: Colors.blueGrey.shade600,
              value: (batBallInfo(odiData['Bat']))['OnField'].toString(),
            ),
          ]),
          SizedBox(
            height: 10,
            ...
            child: Container(
              ...
              child: Padding(
                ...
                child: Center(
                  child: Text(
                      'On Balling : ' +
                          (batBallInfo(odiData['Ball']))['Team'].toString(),
                      textAlign: TextAlign.center,
                      style: TextStyle(
                        color: Colors.white,
                        fontSize: 16,
          ...
          Row(children: [
            OverRun(
              color: Colors.blueGrey.shade600,
              value: (batBallInfo(odiData['Ball']))['OnField'].toString(),
            ),
          ]),
        ]),
      ),
      ...
      Column(children: [
        ...
        Row(
          children: [
            ...
            OverRun(
              color: Colors.blueGrey.shade600,
              value: widget.matchData["overRuns"]['T1Runs'] ?? "--".toString(),
            ),
          ],
        ),
        Row(children: [
